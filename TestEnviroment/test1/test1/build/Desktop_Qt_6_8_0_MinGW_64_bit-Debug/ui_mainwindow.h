...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lblStatus->setGeometry(QRect(60, 50, 161, 41));
        btnAddTask = new QPushButton(centralwidget);
        btnAddTask->setObjectName("btnAddTask");
        btnAddTask->setGeometry(QRect(420, 70, 75, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lblStatus->setText(QCoreApplication::translate("MainWindow", "Status: 0 todo/0 donr", nullptr));
